      ...
      <main>
        <section className="bg-white dark:bg-gray-900">
          <div className="container mx-auto px-6 py-16 text-center">
            <div className="mx-auto max-w-lg">
              ...
              We are passionate about empowering individuals to chase their dreams of studying abroad. Our educational loans serve as the fuel that propels students towards a brighter future. With favorable terms and conditions, we ensure that financial limitations do not hinder the pursuit of educational aspirations.
              </p>
            </div>
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="container mx-auto px-6 py-10">
            ...
            At BRAND, our mission is to empower individuals from all walks of life to fulfill their aspirations of studying abroad by providing accessible educational loans. We firmly believe that education is a transformative force that knows no borders, and we are committed to breaking down financial barriers that often hinder students pursuit of knowledge and personal growth on an international scale. Our mission is rooted in the core belief that everyone deserves equal opportunities to access quality education, regardless of their economic circumstances.</p>
            <p className="mt-10 text-center font-sans text-lg">We strive to bridge the financial gap that students face when seeking education overseas. Through our comprehensive loan programs, we provide tailored solutions and competitive interest rates to ensure that financing does not become a hindrance to the pursuit of educational excellence. We prioritize transparency and flexibility, working closely with each student to understand their unique needs and crafting loan options that align with their specific academic and financial requirements.</p>
            ...
            <p className="mt-10 text-center justify-center font-sans text-lg">
            Our vision is to be the leading provider of educational loans for students seeking to study abroad, driven by a commitment to educational equality and global excellence. We envision a future where studying abroad is within reach for every deserving student, regardless of their financial background. We aspire to create a seamless path to higher education overseas, where students can explore and embrace global opportunities, fostering intellectual curiosity, cultural appreciation, and personal growth.</p>
            <p className="mt-10 text-center font-sans text-lg">Through our efforts, we aim to shape a world where individuals from all corners of the globe can transcend borders and access education that empowers them to reach their full potential. We envision a society where knowledge and skills are acquired in a truly global context, equipping individuals with the tools to tackle complex challenges, foster innovation, and drive positive change.</p>
            <p className="mt-10 text-center font-sans text-lg">Through our work, we seek to inspire a new generation of global citizens—individuals who are not only academically accomplished but also possess the cultural competence, empathy, and open-mindedness needed to navigate and contribute to an increasingly interconnected world. We envision graduates who emerge as catalysts for positive transformation, leaders in their respective fields, and ambassadors of cross-cultural understanding.</p>
                </div>
          </div>
        </section>
