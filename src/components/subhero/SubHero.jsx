      ...
      <div className="container mx-auto px-5 py-24">
        <div className="mx-auto w-full text-center lg:w-3/4 xl:w-1/2">
          ...
          <p className="text-lg leading-relaxed">
            we understand that pursuing higher education is a transformative
            journey that requires dedication, passion, and financial support. We
            are here to provide the necessary resources and guidance to make
            your dreams a reality. Our team is composed of experienced
            ...
            goals and aspirations. We believe in transparency and ethical
            practices, ensuring that our loan terms are fair, competitive, and
            designed to support your educational journey without burdening you
            with excessive debt.
          </p>
